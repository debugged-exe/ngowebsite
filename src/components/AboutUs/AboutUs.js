  ...
  return (
    <div className='about-us' id="aboutUs">
      <div className="tc">
        ...
        <h3 className="mt2 about-line">We're an international organisation working with people in 50 countries for a world free from poverty and injustice.</h3>
      </div>

      <div className="grid-container ma3">
        <img src="https://i.postimg.cc/QCtYH873/poorkids1.png" height="550px" className="ml5" />
